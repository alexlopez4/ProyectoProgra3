...
public class CreateTable {
	...
	public static void main(String[] args){
		...
		createNewTable("CREATE TABLE IF NOT EXISTS registroMensajes(\n"
				...
				+"PRIMARY KEY(NOMBREUSUARIO,IDSALADEBATE,MENSAJE)\n"
				+ ");");
		
		createNewTable("CREATE TABLE temporadadeliga(\n"
				+"EDICION VARCHAR(10) REFERENCES TEMPORADA(EDICION) ON DELETE CASCADE,\n"
				+"IDLIGA NUMBER REFERENCES LIGA(IDLIGA) ON DELETE CASCADE,\n"
				+"CAMPEON NUMBER REFERENCES EQUIPO(IDEQUIPO) ON DELETE CASCADE\n,"
